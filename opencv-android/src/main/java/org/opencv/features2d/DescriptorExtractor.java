 ...
 *
 * @see <a href="http://docs.opencv.org/modules/features2d/doc/common_interfaces_of_descriptor_extractors.html#descriptorextractor">org.opencv.features2d.DescriptorExtractor
 * : public Algorithm</a>
 */
public class DescriptorExtractor {
    ...
    public static final int SIFT = 1, SURF = 2, ORB = 3, BRIEF = 4, BRISK = 5, FREAK = 6,
    ...
    public void compute(List<Mat> images, List<MatOfKeyPoint> keypoints, List<Mat> descriptors) {
        ...
        compute_1(nativeObj, images_mat.nativeObj, keypoints_mat.nativeObj,
    ...
    private static native void compute_1(long nativeObj, long images_mat_nativeObj,
        long keypoints_mat_nativeObj, long descriptors_mat_nativeObj);
