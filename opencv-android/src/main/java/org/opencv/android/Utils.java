...
public class Utils {
     ...
     * <br>The output Mat is always created of the same size as the input Bitmap and of the
     * 'CV_8UC4' type,
     ...
     * converted from alpha premultiplied format (like Android keeps 'ARGB_8888' ones) to regular
