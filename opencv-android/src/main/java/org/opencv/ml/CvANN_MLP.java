 ...
 * new training data.</p>
 *
 * @see <a href="http://docs.opencv.org/modules/ml/doc/neural_networks.html#cvann-mlp">org.opencv.ml.CvANN_MLP
...
public class CvANN_MLP extends CvStatModel {
    ...
    public int train(Mat inputs, Mat outputs, Mat sampleWeights, Mat sampleIdx,
        ...
        int retVal =
            train_0(nativeObj, inputs.nativeObj, outputs.nativeObj, sampleWeights.nativeObj,
                sampleIdx.nativeObj, params.nativeObj, flags);
    ...
    public int train(Mat inputs, Mat outputs, Mat sampleWeights) {
        ...
        int retVal =
            train_1(nativeObj, inputs.nativeObj, outputs.nativeObj, sampleWeights.nativeObj);
