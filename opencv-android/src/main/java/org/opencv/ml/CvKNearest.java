 ...
 * </ul>
 *
 * @see <a href="http://docs.opencv.org/modules/ml/doc/k_nearest_neighbors.html#cvknearest">org.opencv.ml.CvKNearest
...
public class CvKNearest extends CvStatModel {
    ...
    public CvKNearest(Mat trainData, Mat responses, Mat sampleIdx, boolean isRegression,
        ...
        super(CvKNearest_1(trainData.nativeObj, responses.nativeObj, sampleIdx.nativeObj,
            isRegression, max_k));
    ...
    public float find_nearest(Mat samples, int k, Mat results, Mat neighborResponses, Mat dists) {
        ...
        float retVal = find_nearest_0(nativeObj, samples.nativeObj, k, results.nativeObj,
            neighborResponses.nativeObj, dists.nativeObj);
    ...
    public boolean train(Mat trainData, Mat responses, Mat sampleIdx, boolean isRegression,
        int maxK, boolean updateBase) {

        boolean retVal =
            train_0(nativeObj, trainData.nativeObj, responses.nativeObj, sampleIdx.nativeObj,
