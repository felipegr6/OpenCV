 ...
 *
 * @see <a href="http://docs.opencv.org/modules/ml/doc/expectation_maximization.html#em">org.opencv.ml.EM
 * : public Algorithm</a>
 */
public class EM extends Algorithm {
    ...
    public boolean train(Mat samples, Mat logLikelihoods, Mat labels, Mat probs) {
        ...
        boolean retVal =
            train_0(nativeObj, samples.nativeObj, logLikelihoods.nativeObj, labels.nativeObj,
                probs.nativeObj);
    ...
    public boolean trainE(Mat samples, Mat means0, Mat covs0, Mat weights0, Mat logLikelihoods,
        ...
        boolean retVal = trainE_0(nativeObj, samples.nativeObj, means0.nativeObj, covs0.nativeObj,
    ...
    public boolean trainM(Mat samples, Mat probs0, Mat logLikelihoods, Mat labels, Mat probs) {
        ...
        boolean retVal =
            trainM_0(nativeObj, samples.nativeObj, probs0.nativeObj, logLikelihoods.nativeObj,
