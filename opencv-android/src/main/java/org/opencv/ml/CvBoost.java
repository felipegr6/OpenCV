 ...
 *
 * @see <a href="http://docs.opencv.org/modules/ml/doc/boosting.html#cvboost">org.opencv.ml.CvBoost
...
public class CvBoost extends CvStatModel {
    ...
    public CvBoost(Mat trainData, int tflag, Mat responses, Mat varIdx, Mat sampleIdx, Mat varType,
        Mat missingDataMask, CvBoostParams params) {

        super(CvBoost_1(trainData.nativeObj, tflag, responses.nativeObj, varIdx.nativeObj,
    ...
    public float predict(Mat sample, Mat missing, Range slice, boolean rawMode, boolean returnSum) {
        ...
        float retVal =
            predict_0(nativeObj, sample.nativeObj, missing.nativeObj, slice.start, slice.end,
                rawMode, returnSum);
    ...
    public boolean train(Mat trainData, int tflag, Mat responses, Mat varIdx, Mat sampleIdx,
        Mat varType, Mat missingDataMask, CvBoostParams params, boolean update) {
