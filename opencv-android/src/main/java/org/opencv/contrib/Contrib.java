...
public class Contrib {
    ...
    public static final int RETINA_COLOR_RANDOM = 0, RETINA_COLOR_DIAGONAL = 1, RETINA_COLOR_BAYER =
        2, ROTATION = 1, TRANSLATION = 2, RIGID_BODY_MOTION = 4, COLORMAP_AUTUMN = 0,
        COLORMAP_BONE = 1, COLORMAP_JET = 2, COLORMAP_WINTER = 3, COLORMAP_RAINBOW = 4,
